...
/**
 * v3.1.2 — TrackPicker (Campus). Mirrors the Workforce TrackPicker so both
 * portals see the SAME shared career-track catalogue. The Dean creating
 * "B.Tech CSE" links to the same canonical track that an employer hires
 * under for "Senior Backend Engineer" — provided they pick from the same
 * catalogue entry. Cluster mapping (the IP) is auto-derived per new track.
 */
