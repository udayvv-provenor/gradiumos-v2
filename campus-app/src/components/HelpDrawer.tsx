/**
 * BC 171 + BC 172 — HelpDrawer (Campus portal)
 *
 * Slide-in help panel. Three tabs: Docs, Contact, Status.
 * FAQ content is campus/institution-specific.
 */
  ...
  const faqs: { q: string; a: string }[] = [
    {
      ...
      a: 'The Dashboard shows gap analysis across your enrolled learners. Each cluster card displays the median score and the proportion of learners below the threshold. Click a cluster for a full distribution breakdown.',
    },
    {
      q: 'What is the GradiumOS Signal?',
      a: 'The Signal is a verified, portable competency credential issued to learners once they meet confidence thresholds across the 8 clusters. It can be shared with employers and verified without requiring login.',
    },
    {
      q: 'How do I add a learner to the institution?',
      a: 'Go to Learners and press "Add Learner". Either enter the learner\'s email (they receive a temporary password) or share the institution invite code so they can self-register with a verified email.',
    },
    {
      q: 'How do I map curriculum to career tracks?',
      a: 'Open Career Tracks and select a track. The cluster-to-subject mapping shows which course modules cover each of the 8 clusters. Use this to identify curriculum gaps aligned to industry demand.',
    },
    {
      q: 'How do I export a cohort report?',
      a: 'From the Learners page, press "Export" to download a CSV with Signal status, cluster scores, and gap flags for all enrolled learners. Suitable for board presentations and accreditation evidence.',
    },
  ]
