 ...
 * Provides:
 *   - BellButton: compact bell + badge, used inline in Layout/Sidebar topbar
 *   - NotificationDrawer: full slide-in list with mark-read actions
 */
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-rule">
          <div>
            ...
            {unreadCount > 0 && (
              <div className="text-xs text-slate mt-0.5">{unreadCount} unread</div>
            )}
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading && (
            <div className="flex items-center justify-center h-32 text-sm text-slate">Loading…</div>
          )}
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className={clsx('text-xs font-semibold truncate', n.readAt ? 'text-slate' : 'text-ink')}>
                    {n.title}
                  </div>
        ...
        <div className="px-5 py-3 border-t border-rule flex items-center justify-between">
          <button
            onClick={() => { navigate('/notifications/archive'); onClose() }}
